// ****************************************************************************
// <copyright file="WeakEventHandler{T}.cs" company="Pedro Lamas">
...
namespace Cimbalino.Toolkit.Helpers
{
    ...
    public class WeakEventHandler<T> : IDisposable where T : EventArgs
    {
        ...
        /// <summary>
        /// Gets or sets a <see cref="WeakReference"/> to the target of this <see cref="WeakEventHandler{T}"/>.
        /// </summary>
        /// <value>A <see cref="WeakReference"/> to the target of this <see cref="WeakEventHandler{T}"/>.</value>
        protected WeakReference Reference { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="MethodInfo" /> corresponding to this <see cref="WeakEventHandler{T}"/>.
        /// </summary>
        /// <value>The <see cref="MethodInfo" /> corresponding to this <see cref="WeakEventHandler{T}"/>.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WeakEventHandler{T}"/> class.
        /// </summary>
        ...
        public WeakEventHandler(EventHandler<T> eventHandler, Action<EventHandler<T>> subscribeAction, Action<EventHandler<T>> unsubscribeAction)
        ...
        /// <param name="subscribeAction">The action to subscribe the event handler.</param>
        /// <param name="unsubscribeAction">The action to unsubscribe the event handler.</param>
        public WeakEventHandler(object target, EventHandler<T> eventHandler, Action<EventHandler<T>> subscribeAction, Action<EventHandler<T>> unsubscribeAction)
        {

// ****************************************************************************
// <copyright file="WeakEventHandler.cs" company="Pedro Lamas">
...
namespace Cimbalino.Toolkit.Helpers
{
    ...
    public class WeakEventHandler : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets a <see cref="WeakReference"/> to the target of this <see cref="WeakEventHandler"/>.
        /// </summary>
        /// <value>A <see cref="WeakReference"/> to the target of this <see cref="WeakEventHandler"/>.</value>
        protected WeakReference Reference { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="MethodInfo" /> corresponding to this <see cref="WeakEventHandler"/>.
        /// </summary>
        /// <value>The <see cref="MethodInfo" /> corresponding to this <see cref="WeakEventHandler"/>.</value>
        ...
        public WeakEventHandler(EventHandler eventHandler, Action<EventHandler> subscribeAction, Action<EventHandler> unsubscribeAction)
        ...
        /// <param name="subscribeAction">The action to subscribe the event handler.</param>
        /// <param name="unsubscribeAction">The action to unsubscribe the event handler.</param>
        public WeakEventHandler(object target, EventHandler eventHandler, Action<EventHandler> subscribeAction, Action<EventHandler> unsubscribeAction)
        {

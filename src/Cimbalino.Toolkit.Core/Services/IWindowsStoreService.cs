// ****************************************************************************
// <copyright file="IWindowsStoreService.cs" company="Pedro Lamas">
...
namespace Cimbalino.Toolkit.Services
{
    ...
    public interface IWindowsStoreService
    {
        ...
        Task<WindowsStoreServiceAppNode> GetAppInformationAsync();
        ...
        /// <returns>The <see cref="Task"/> object representing the asynchronous operation.</returns>
        Task<WindowsStoreServiceAppNode> GetAppInformationAsync(string productId);
    }
}